    ...
    <div className="flex flex-col gap-y-20 items-start pt-[100px] min-h-screen px-5 lg:px-60">
      <div className="grid grid-cols-2 w-full gap-x-5">
        <div className="mt-10">
          ...
          <div className="overflow-hidden">
            <h3 className="subtitle-text animate-text">
              In the June 2024, Graduated from Vadodara Institute of Eng. (VIER). But learned all the coding by my self. Through YouTube & Documentations.
            </h3>
          </div>
          <div className="overflow-hidden my-5">
            <h3 className="subtitle-text animate-text">
              I loved the NextJS concepts. So I decided to learn it directly. I don&apos;t know React fr. And the docs really helped me to learn the language.
            </h3>
          </div>
        </div>
        <div
